    ...
    onCollide(params: {
        ...
        if (this.state.state == "Walking") {
            if (params.other instanceof Kitty && !params.other.state.dead) {
                //
                let squashMaxY =
                    this.actor.state.pos.y + this.actor.state.size.y * 0.2;
                let kittyMaxY =
                    params.other.actor.state.pos.y +
                    params.other.actor.state.size.y;
                //
                if (kittyMaxY <= squashMaxY) {
                    ...
                    this.actor.setState(
                        ...
                        (y) =>
                            y -
                            (KOOPA_TROOPA_2_HEIGHT - KOOPA_TROOPA_1_HEIGHT) * 5,
                    );
            ...
            if (params.other instanceof Kitty && !params.other.state.dead) {
                let scx =
                    this.actor.state.pos.x + 0.5 * this.actor.state.size.x;
                let kcx =
