...
const KOOPA_TROOPA_WIDTH = 17;
const KOOPA_TROOPA_1_HEIGHT = 27;
const KOOPA_TROOPA_2_HEIGHT = 16;
...
export const smSpriteAtlasData = {
    frames: {
        ...
        koopa_troopa_walking_1: {
            frame: { x: KOOPA_TROOPA_1_OFFSET_X, y: KOOPA_TROOPA_1_OFFSET_Y, w: KOOPA_TROOPA_WIDTH, h: KOOPA_TROOPA_1_HEIGHT, }
        },
        koopa_troopa_walking_2: {
            frame: { x: KOOPA_TROOPA_2_OFFSET_X, y: KOOPA_TROOPA_1_OFFSET_Y, w: KOOPA_TROOPA_WIDTH, h: KOOPA_TROOPA_1_HEIGHT, }
        },
        koopa_troopa_shell_1: {
            frame: { x: KOOPA_TROOPA_3_OFFSET_X, y: KOOPA_TROOPA_2_OFFSET_Y, w: KOOPA_TROOPA_WIDTH, h: KOOPA_TROOPA_2_HEIGHT, }
        },
        koopa_troopa_shell_2: {
            frame: { x: KOOPA_TROOPA_4_OFFSET_X, y: KOOPA_TROOPA_2_OFFSET_Y, w: KOOPA_TROOPA_WIDTH, h: KOOPA_TROOPA_2_HEIGHT, }
        },
        koopa_troopa_shell_3: {
            frame: { x: KOOPA_TROOPA_5_OFFSET_X, y: KOOPA_TROOPA_2_OFFSET_Y, w: KOOPA_TROOPA_WIDTH, h: KOOPA_TROOPA_2_HEIGHT, }
        },
        koopa_troopa_shell_4: {
            frame: { x: KOOPA_TROOPA_6_OFFSET_X, y: KOOPA_TROOPA_2_OFFSET_Y, w: KOOPA_TROOPA_WIDTH, h: KOOPA_TROOPA_2_HEIGHT, }
        },
        koopa_troopa_waking_up: {
            frame: { x: KOOPA_TROOPA_7_OFFSET_X, y: KOOPA_TROOPA_2_OFFSET_Y, w: KOOPA_TROOPA_WIDTH, h: KOOPA_TROOPA_2_HEIGHT, }
        },
    },
    meta: {
        image: SM_SPRITES,
