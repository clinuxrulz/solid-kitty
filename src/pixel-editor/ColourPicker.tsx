...
const ColourPicker: Component<{
    ...
    let [colourChartSize, setColourChartSize] = createSignal<
        Vec2 | undefined
    >();
    createComputed(() => {
    ...
    */
    ...
    createEffect(() => {
        ...
        setState(
            ...
            Math.max(
                0,
                Math.min(255, Math.floor((256 * (sizeY - pt.y)) / sizeY)),
            ),
        );
    });
    createEffect(() => {
            ...
            () => {
                ...
                let i = Math.max(
                    ...
                    Math.min(
                        canvas2.size.y,
                        Math.floor(
                            ((255 - state.brightness) * canvas2.size.y) / 256,
                        ),
                    ),
                );
                let offset = i << 2;
    ...
    let [colourPreviewDiv, setColourPreviewDiv] =
                ...
                >
                    ...
                    >
                        <rect
                            ...
                            y={
                                (canvas()?.size.y ?? 0) -
                                (state.brightness * (canvas()?.size.y ?? 0)) /
                                    255 -
                                5
                            }
                            width={24}
                                    ...
                                    <input
                                        ...
                                        onInput={(e) => {
                                            batch(() => {
                                                ...
                                                setState(
                                                    "userGreenText",
                                                    currentColour().g.toFixed(
                                                        0,
                                                    ),
                                                );
                                                setState(
                                                    "userBlueText",
                                                    currentColour().b.toFixed(
                                                        0,
                                                    ),
                                                );
                                                setState(
                                                    "userAlphaText",
                                                    currentColour().a.toFixed(
                                                        0,
                                                    ),
                                                );
                                            });
