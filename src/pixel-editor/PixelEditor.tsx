...
const PixelEditor: Component = () => {
    ...
    let modeParams: ModeParams = {
        ...
        writePixel(pt: Vec2, colour: Colour): void {
            ...
            let offset =
                (image3.imageData.width * (pt.y - minPt.y) +
                    (pt.x - minPt.x)) <<
                2;
                ...
                >
                    ...
                    <button
                        ...
                        style={{
                            "font-size": "20pt",
                            padding: "5pt",
                            "background-color": state.showColourPicker
                                ? "blue"
                                : undefined,
                        }}
                        onClick={() => {
                ...
                >
                    ...
                    >
                        {(() => {
                            ...
                            let pt1 = createMemo(() =>
                                worldPtToScreenPt(state.minPt),
                            );
                            let pt2 = createMemo(() =>
                                worldPtToScreenPt(
                                    state.minPt.clone().add(state.size),
                                ),
                            );
                            let rect = createMemo(() => {
                                let pt12 = pt1();
