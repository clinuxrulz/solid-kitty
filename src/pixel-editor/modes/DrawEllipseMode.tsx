...
export class DrawEllipseMode implements Mode {
    ...
    constructor(modeParams: ModeParams) {
        ...
        let resizeHelper = createMemo(() => {
            ...
            let pos = (() => state.pos) as Accessor<
                NonNullable<typeof state.pos>
            >;
            ...
            return new ResizeHelper({
                ...
                rect: {
                    ...
                    setPos: (pos) => {
                        setState(
                            "pos",
                            Vec2.create(Math.round(pos.x), Math.round(pos.y)),
                        );
                    },
                    setSize: (size) => {
                        setState(
            ...
            createComputed(() => {
                ...
                createComputed(() => {
                    ...
                    drawEllipse(pos2.x, pos2.y, size2.x, size2.y, (x, y) => {
                        ...
                        let oldColour =
                            modeParams.readPixel(pos) ?? new Colour(0, 0, 0, 0);
