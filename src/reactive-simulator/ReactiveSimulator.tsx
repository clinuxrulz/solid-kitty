            ...
            >
                <button
                    style={{
                        ...
                        "margin-left": "5px",
                        "background-color":
                            state.mode == "Add Node" ? "blue" : undefined,
                    }}
                ...
                <button
                    style={{
                        ...
                        "margin-left": "5px",
                        "background-color":
                            state.mode == "Mark Dirty" ? "blue" : undefined,
                    }}
                ...
                <button
                    style={{
                        ...
                        "margin-left": "5px",
                        "background-color":
                            state.mode == "Running" ? "blue" : undefined,
                    }}
