                        ...
                        switch (component.type.typeName) {
                            case catmullRomSplineComponentType.typeName: {
                                let catmullRomeSplineState =
                                    (component as EcsComponent<CatmullRomSplineState>).state;
                                result.push(
...
export function romPointsToPathData(points: [number, number][], closed: boolean = false, alpha: number = 0.5) {
  let pathData;
...
function openRomCurveToPathData(points: [number, number][], alpha: number): { type:string, values: number[], }[] {
  let pathData: {
    type: string,
    values: number[],
  }[] = [];
...
function closedRomCurveToPathData(points: [number, number][], alpha: number = 0.5): { type: string, values: number[], }[] {
  let pathData: {
    type: string,
    values: number[],
  }[] = [];
